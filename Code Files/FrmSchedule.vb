...
Public Class FrmSchedule
    ...
    Private Sub FrmSchedule_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Frminfo.mHebrewMenus.Checked = True Then
            ...
            LabelSound.Font = MemoryFonts.GetFont(1, 8.75, FontStyle.Regular)
            LabelFrom.Font = MemoryFonts.GetFont(1, 8.75, FontStyle.Regular)
        ...
        Else
            ...
            LabelSound.Font = MemoryFonts.GetFont(1, 7.75, FontStyle.Regular)
            LabelFrom.Font = MemoryFonts.GetFont(1, 7.75, FontStyle.Regular)
